...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=0.02,
                        help='learning rate')
    parser.add_argument('--weight_decay', type=float, default=0.00001,help='l2 reg')
    ...
    for l in range(1):
        ...
        if adaptive_lr == 'False':
            ...
            optimizer = torch.optim.Adam([{'params': model.linear1.parameters()},
                                          ...
                                          {'params': model.HomogRelationAttention.parameters(), "lr": 0.02, "weight_decay": 0.001},
                                          {'params': model.HeterogRelationAttention.parameters(), "lr": 0.02, "weight_decay": 0.001},
    ...
    f=open("dataimdb.dat","w")
    print("Run Macro_F1 Micro_F1 NMI ARI",file=f)
    f=open("data.dat","a")
    f.close 

    f=open("dataimdb.dat","a")
